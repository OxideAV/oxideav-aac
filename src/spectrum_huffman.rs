...
//! to own.
//!
//! This module lands the first of the eleven spectrum Huffman
//! codebooks — **Table 4.A.2, "Spectrum Huffman Codebook 1"** —
//! together with the encode / decode primitives that the upcoming
//! `spectral_data()` walker will dispatch onto. Codebooks 2..=11
//! (Tables 4.A.3 … 4.A.12) reuse the exact same structural shape
//! (entry count = `mod^dim` where `mod = lav + 1` unsigned or
//! `2 * lav + 1` signed) and will be added one per future round; the
...
//!
//! * Codebooks 2..=11 (Tables 4.A.3 … 4.A.12). Each will land as a
