...
/// SBR FIL extension appearing BEFORE any SCE / CPE in the same
/// raw_data_block routed itself to `last_elem_start = 0` (the
/// initial-state slot), then once a legitimate later CPE landed at
/// slot 0 it inherited the bogus SBR data and emitted 2048 samples
/// per channel. libavcodec rejects this with "SBR was found before
/// the first channel element" and emits the 1024-sample AAC-LC core.
///
/// ISO/IEC 14496-3 §4.4.2.3 Note 1 (Table 4.57): an SBR extension
/// payload MUST attach to the immediately preceding SCE / CPE / LFE.
/// A fill_element carrying SBR but appearing before any channel
/// element is non-conformant; the SBR bytes are silently dropped.
///
/// Fix (`src/decoder.rs` SBR-FIL parse path): if `got_channels == 0`
/// when an SBR-shaped FIL is encountered, treat it as a non-SBR
/// extension and skip the payload bytes. Trailing channel elements
/// still decode normally and `sbr_data[..]` stays None, so the
/// frame emits 1024 samples per channel (matching libavcodec).
///
/// Exact bytes from
/// `fuzz/artifacts/ffmpeg_oracle_decode/crash-de1c9e6579a29d50d73be17ed5228cb46d1d76e6`.
#[test]
fn sbr_before_first_channel_element_emits_core_only_oracle_next() {
    let data: [u8; 232] = [
        ,
    ];
    let params = CodecParameters::audio(CodecId::new("aac"));
    let Ok(mut dec) = make_decoder(&params) else {
        return;
    ...
    // Contract: SBR before any channel element MUST be silently
    // dropped; no frame may emit 2048 samples per channel.
    assert!(
        max_samples <= 1024,
